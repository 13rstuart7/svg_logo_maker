...
.then(answers=>{
	let shape;
	if(answers.pixel_image=="Circle"){
		shape=new Circle(answers.shape,answers.text_color,answers.text)
	fs.writeFileSync("./output/shape.svg",shape.render())
	}

	if(answers.pixel_image=="Square"){
		shape=new Square(answers.shape,answers.text_color,answers.text)
		console.log(shape)
	fs.writeFileSync("./output/shape.svg",shape.render())
	}
	if(answers.pixel_image=="Triangle"){
		shape=new Triangle(answers.shape,answers.text_color,answers.text)
		console.log(shape)
	fs.writeFileSync("./output/shape.svg",shape.render())
	}
	// console.log(shape)
